	...
	<div class="section m-t-lg wrapper-md animated fadeInUp banner" >
		<main class="container aside-xl" style="padding-top: 0;">
			<section class="m-b-lg">
					...
					<?php echo form_open('onehealth/process_patient_sign_up',$attributes); ?>
						<div class="list-group">
							...
							<button type="submit" id="submit-btn" class="btn btn-lg disabled btn-primary btn-block submit">
				    ...
				    $.ajax({
				        ...
				        success : function (response) {
				          ...
				          if(response.success == true && response.successful == true){
				            document.location.assign("<?php echo site_url('onehealth/cl_admin') ?>")
