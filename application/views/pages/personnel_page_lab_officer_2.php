...
<script>
  ...
  function inputTestValues (elem,evt) {
    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patients_ready_for_inputing_of_result_standard'); ?>"
  ...
  function loadTestsAndPatientInfo(elem,evt,lab_id,scroll_down = false){
    ...
    if(lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patient_info_for_inputing_of_results_standard'); ?>"
  ...
  function enterResultOfTest(elem,evt,main_test_id,lab_id){
    ...
    if(main_test_id != "" && lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_enter_result_form_for_main_test_only_standard'); ?>"
  ...
  function enterResultOfTest1(elem,evt,main_test_id,lab_id){
    ...
    var test_name = elem.attr("data-test-name");
    if(main_test_id != "" && lab_id != ""){
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_enter_result_form_for_tests_with_sub_tests_only_standard'); ?>"
