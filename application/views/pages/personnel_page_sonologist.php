...
<script>
  ...
  function inputResults (elem,evt,enter = true) {
    ...
    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patients_awaiting_sonologist'); ?>";
    var form_data = {};
    view_mode = "enter";
  ...
  function  loadTestsAndPatientInfo(elem,evt,lab_id,scroll_down = false,enter = true){
    ...
    if(lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patient_info_for_sonologist'); ?>"
      var form_data = {
        show_records : true,
        lab_id : lab_id
      }
  ...
  function enterResultOfTest(elem,evt,main_test_id,lab_id,enter = true){
    ...
    if(main_test_id != "" && lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_edit_result_form_for_sonologist'); ?>";
      var form_data = {
        show_records : true,
        main_test_id : main_test_id,
        lab_id : lab_id
  ...
  function proceedSubmitCommentsRadiographer(elem,evt){
    ...
    if(lab_id != "" && main_test_id != "" && comments != "" && type != ""){
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_test_result_form_sonologist'); ?>";
  ...
  function inputResultsEdit (elem,evt,enter = true) {
    ...
    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patients_awaiting_sonologist_edit'); ?>";
    var form_data = {};
    view_mode = "enter";
  ...
  function loadTestsAndPatientInfoEdit(elem,evt,lab_id,scroll_down = false,enter = true){
    ...
    if(lab_id != ""){
      patient_lab_id = lab_id;
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patient_info_for_sonologist_edit'); ?>"
      var form_data = {
        show_records : true,
        lab_id : lab_id
      }
  ...
  function enterResultOfTestEdit(elem,evt,main_test_id,lab_id,enter = true){
    ...
    if(main_test_id != "" && lab_id != ""){
      patient_lab_id = lab_id;
      patient_main_test_id = main_test_id;
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_edit_result_form_for_sonologist_edit'); ?>";
      var form_data = {
        show_records : true,
        main_test_id : main_test_id,
        lab_id : lab_id
