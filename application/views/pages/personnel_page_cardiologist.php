...
<script>
  ...
  function viewTestsAwaitingCardiologist (elem,evt,enter = true) {

    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patients_awaiting_cardiologist'); ?>";
    var form_data = {};
    view_mode = "enter";
    ...
    $.ajax({
      ...
      success : function (response) {
        ...
        if(response.success && response.messages != ""){
          $("#patients-awaiting-cardiologist-card .card-body").html(response.messages);
          $("#patients-awaiting-cardiologist-card #input-results-table").DataTable();
          $("#main-card").hide();
          
          $("#patients-awaiting-cardiologist-card").show();
        }else{
          $.notify({
          message:"Sorry Something Went Wrong."
          },{
  ...
  function  loadTestsAndPatientInfo(elem,evt,lab_id,scroll_down = false,enter = true){
    ...
    if(lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patient_info_for_cardiologist'); ?>"
      var form_data = {
        show_records : true,
        lab_id : lab_id
      }
      ...
      $.ajax({
        ...
        success : function (response) {
          ...
          if(response.success && response.messages != ""){
            ...
            viewTestsAwaitingCardiologist(elem,evt);
          }else{
            $.notify({
            message:"Sorry Something Went Wrong."
            },{
  ...
  function enterResultOfTest(elem,evt,main_test_id,lab_id,enter = true){
    ...
    if(main_test_id != "" && lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_edit_result_form_for_cardiologist'); ?>";
      var form_data = {
        show_records : true,
        main_test_id : main_test_id,
        lab_id : lab_id
  ...
  function submitCardiologistComments(elem,evt){
    elem = $(elem);
    ...
    if(comments_length >= 2){
      ...
      if(lab_id != "" && main_test_id != "" && comments != ""){
        var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_test_result_form_cardiologist'); ?>";
  ...
  function viewTestsAwaitingCardiologistEdit (elem,evt) {

    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patients_awaiting_cardiologist_edit'); ?>";
    var form_data = {};
    ...
    $.ajax({
      ...
      success : function (response) {
        ...
        $(".spinner-overlay").hide();
        if(response.success && response.messages != ""){
          $("#patients-awaiting-cardiologist-card-edit .card-body").html(response.messages);
          $("#patients-awaiting-cardiologist-card-edit #input-results-table").DataTable();
          $("#main-card").hide();
          
          $("#patients-awaiting-cardiologist-card-edit").show();
        }else{
          $.notify({
          message:"Sorry Something Went Wrong."
          },{
  ...
  function loadTestsAndPatientInfoEdit(elem,evt,lab_id,scroll_down = false,enter = true){
    ...
    if(lab_id != ""){
      patient_lab_id = lab_id;
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patient_info_for_cardiologist_edit'); ?>"
      var form_data = {
        show_records : true,
        lab_id : lab_id
      }
      ...
      $.ajax({
        ...
        success : function (response) {
          ...
          if(response.success && response.messages != ""){
            ...
            viewTestsAwaitingCardiologistEdit(elem,evt);
          }else{
            $.notify({
            message:"Sorry Something Went Wrong."
            },{
   ...
   function enterResultOfTestEdit(elem,evt,main_test_id,lab_id,enter = true){
    ...
    if(main_test_id != "" && lab_id != ""){
      patient_lab_id = lab_id;
      patient_main_test_id = main_test_id;
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_edit_result_form_for_cardiologist_edit'); ?>";
      var form_data = {
        show_records : true,
        main_test_id : main_test_id,
        lab_id : lab_id
  ...
  function submitCardiologistCommentsEdit(elem,evt){
    elem = $(elem);
    var lab_id = elem.attr("data-lab-id");
    var main_test_id = elem.attr("data-main-test-id");
        ...
        <?php } ?>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="card" id="patients-awaiting-cardiologist-card" style="display: none;">
                <div class="card-header">
                  <button onclick="goBackFromPatientsAwaitingCardiologistCard(this,event)" class="btn btn-warning">Go Back</button>
                  <h3 class="card-title">Patient's Awaiting Cardiologist</h3>
                </div>
                <div class="card-body">
              ...
              <div class="card" id="patients-awaiting-cardiologist-card-edit" style="display: none;">
                <div class="card-header">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-hover" id="perform-action-on-patient-modal" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td onclick="viewTestsAwaitingCardiologist(this,event)" class="text-primary">View Patients Awaiting Cardiologist</td>
                        </tr>
                        <tr>
                          <td>2</td>
                          <td onclick="viewTestsAwaitingCardiologistEdit(this,event,false)" class="text-primary">View Previously Processed Patients</td>
                        </tr>
