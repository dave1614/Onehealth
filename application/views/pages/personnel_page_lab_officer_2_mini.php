...
<script>
  ...
  function deleteImage (elem,evt,lab_id,main_test_id,image_name) {
    ...
    swal({
      ...
      var delete_test_images = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition.'/'.$fourth_addition.'/delete_test_result_image_mini') ?>";
  ...
  function viewImages (elem,evt,lab_id,main_test_id) {
    elem = $(elem);
    var get_test_images = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition.'/'.$fourth_addition.'/view_images_uploaded_for_test_mini') ?>";
  ...
  function submitImage (elem,evt) {
    ...
    if (typeof image.files !== 'undefined') {
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_images_for_test_mini'); ?>"
      $(".spinner-overlay").show();
      $.ajax({
        url : url,
        type : "POST",
  ...
  function inputTestValues (elem,evt) {
    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patients_ready_for_inputing_of_result_mini'); ?>"
    ...
    $.ajax({
      ...
      success : function (response) {
        ...
        if(response.success && response.messages != ""){
          $("#input-results-card .card-body").html(response.messages);
          $("#input-results-card #input-results-table").DataTable();
          $("#main-card").hide();
          $("#input-results-card").show();
        }else{
          $.notify({
          message:"Sorry Something Went Wrong."
          },{
  ...
  function goBackFromInputResultsCard (elem,evt) {
    $("#main-card").show();
    $("#input-results-card").hide();
  }
  ...
  function  loadTestsAndPatientInfo(elem,evt,lab_id,scroll_down = false){
    ...
    if(lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patient_info_for_inputing_of_results_mini'); ?>"
  ...
  function enterResultOfTest(elem,evt,main_test_id,lab_id){
    ...
    if(main_test_id != "" && lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_enter_result_form_for_main_test_only_mini'); ?>"
      ...
      $.ajax({
        ...
        success : function (response) {
          ...
          if(response.success && response.messages != ""){
            ...
            $("#enter-main-test-result-card .card-title").html("Enter Result Of " + test_name);
  ...
  function enterResultOfTest1(elem,evt,main_test_id,lab_id){
    ...
    var test_name = elem.attr("data-test-name");
    if(main_test_id != "" && lab_id != ""){
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_enter_result_form_for_tests_with_sub_tests_only_mini'); ?>"
      ...
      $.ajax({
        ...
        success : function (response) {
          ...
          if(response.success && response.messages != ""){
            ...
            $("#enter-sub-test-result-card .card-title").html("Enter Results Of " + test_name);
  ...
  function submitEnterResultsMainTest (elem,evt) {
    ...
    if(lab_id != "" && main_test_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_test_result_form_main_test_only_mini'); ?>";
  ...
  function submitEnterResultsTestsWithSubTests (elem,evt) {
    ...
    if(lab_id != "" && main_test_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_test_result_form_sub_test_only_mini'); ?>";
  ...
  function submitImageSubTest (elem,evt) {
    ...
    if (typeof image.files !== 'undefined') {
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_images_for_sub_test_mini'); ?>"
      $(".spinner-overlay").show();
      $.ajax({
        url : url,
        type : "POST",
  ...
  function viewImagesSubTest (elem,evt,lab_id,main_test_id,sub_test_id) {
    elem = $(elem);
    var get_test_images = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition.'/'.$fourth_addition.'/view_images_uploaded_for_sub_test_mini') ?>";
  ...
  function deleteImageSubTest (elem,evt,lab_id,main_test_id,sub_test_id,image_name) {
    ...
    swal({
      ...
      var delete_test_images = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition.'/'.$fourth_addition.'/delete_test_result_image_sub_test_mini') ?>";
      $(".spinner-overlay").show();
      $.ajax({
        url : delete_test_images,
        type : "POST",
  ...
  function submitEditResultsTestsWithSubTests (elem,evt) {
    ...
    if(lab_id != "" && main_test_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_test_result_form_sub_test_only_mini_edit'); ?>";
      ...
      $.ajax({
        ...
        success : function (response) {
          ...
          if(response.success){
            ...
            $("#edit-sub-test-result-card").hide();
            loadTestsAndPatientInfoEdit(elem,evt,lab_id,true);
  ...
  function submitEditResultsMainTest (elem,evt) {
    ...
    if(lab_id != "" && main_test_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_test_result_form_main_test_only_mini_edit'); ?>";
            ...
            <div class="col-sm-12">
              ...
              <div class="card" id="patient-info-card" style="display: none;">
                <div class="card-header">
                  ...
                  <a href="#tests-table-enter" class="btn btn-info">Input Results</a>
                  <h3 class="card-title">Patient Info</h3>
                </div>
                <div class="card-body">
              ...
              <div class="card" id="input-results-card" style="display: none;">
                <div class="card-header">
                  <button onclick="goBackFromInputResultsCard(this,event)" class="btn btn-warning">Go Back</button>
                  <h3 class="card-title">Patient's Ready For Inputing Of Result </h3>
                </div>
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-hover" id="perform-action-on-patient-modal" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td onclick="inputTestValues(this,event)" class="text-primary">Input Test Values</td>
                        </tr>

                        <tr>
                          <td>2</td>
                          <td onclick="viewPreviousResults(this,event)" class="text-primary">View Previously Entered Results </td>
                        </tr>
                        <tr>
                          <td>3</td>
              ...
              <div class="card" id="upload-results-card" style="display: none;">
                ...
                <div class="card-body">
                  <?php
                   ...
                   echo form_open_multipart('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition.'/'.$fourth_addition.'/upload_result_file_mini',$attr); 
                  ?>
                    <h5>Note: </h5>
