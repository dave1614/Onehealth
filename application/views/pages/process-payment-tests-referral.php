         ...
         function addCommas(nStr)
  {
      ...
      <script>
        ...
        $(document).ready(function() {
          ...
          var url = "<?php echo site_url('onehealth/index/'.$addition.'/submit_test_payment_form_referral/'.$third_addition.'?reference='.$_GET["reference"]); ?>";
          ...
          $.ajax({
              ...
              success : function(response){
                ...
                if(response.success && response.records != ""){
                  ...
                  $(".spinner-overlay").hide();
                  var get_pdf_tests_url = "<?php echo site_url('onehealth/index/'.$addition.'/get_tests_referral_online/'.$third_addition) ?>";
                  $(".spinner-overlay").show();
                  $.ajax({
                    ...
                    success : function (response) {
                      ...
                      $(".spinner-overlay").show();
                      var url = "<?php echo site_url('onehealth/index/'.$addition.'/save_receipt_referral/'.$third_addition); ?>";
