...
<script>
  ...
  function inputResults (elem,evt,enter = true) {

    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patients_awaiting_radiographer'); ?>";
    var form_data = {};
    view_mode = "enter";
    ...
    $.ajax({
      ...
      success : function (response) {
        ...
        if(response.success && response.messages != ""){
          $("#patients-awaiting-radiographer-card .card-body").html(response.messages);
          $("#patients-awaiting-radiographer-card #input-results-table").DataTable();
          $("#main-card").hide();
          if(!enter){
            $("#patients-awaiting-radiographer-card .card-title").html("All Patients With Pathologist's Comments Entered");
          }else{
            $("#patients-awaiting-radiographer-card .card-title").html("Patients Awaiting You");
          }
          $("#patients-awaiting-radiographer-card").show();
        }else{
          $.notify({
          message:"Sorry Something Went Wrong."
          },{
  ...
  function goBackFromPatientsAwaitingRadiographerCard (elem,evt) {
    $("#main-card").show();
    $("#patients-awaiting-radiographer-card").hide();
  }
  ...
  function  loadTestsAndPatientInfo(elem,evt,lab_id,scroll_down = false,enter = true){
    ...
    if(lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patient_info_for_radiographer'); ?>"
      var form_data = {
        show_records : true,
        lab_id : lab_id
      }
  ...
  function enterResultOfTest(elem,evt,main_test_id,lab_id,enter = true){
    ...
    if(main_test_id != "" && lab_id != ""){
      ...
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_edit_result_form_for_radiographer'); ?>";
      var form_data = {
        show_records : true,
        main_test_id : main_test_id,
        lab_id : lab_id
      ...
      $.ajax({
        ...
        success : function (response) {
          ...
          if(response.success && response.messages != ""){
            ...
            $("#enter-main-test-result-card .card-title").html("Enter Your Comments For " + test_name);
  ...
  function proceedSubmitCommentsRadiographer(elem,evt){
    elem = $(elem);
    var lab_id = elem.attr("data-lab-id");
    var main_test_id = elem.attr("data-main-test-id");
    var comments = elem.attr("data-comments");
    var type = elem.attr("data-type");

    $("#choose-action-radiographer-modal").modal("hide");

    if(lab_id != "" && main_test_id != "" && comments != "" && type != ""){
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_test_result_form_radiographer'); ?>";
        ...
        success : function (response) {
          ...
          if(response.success){
            if(response.type == "none"){
              ...
              $.notify({
              message:"Results Successfully Inputed And Moved To The Platform Of The " + response.type
              },{
                type : "success"  
              });
            }
  ...
  function submitRadiographerComments(elem,evt){
    elem = $(elem);
    var lab_id = elem.attr("data-lab-id");
    var main_test_id = elem.attr("data-main-test-id");
    ...
    if(comments_length >= 2){
      ...
      if(lab_id != "" && main_test_id != ""){
        $("#choose-action-radiographer-modal button").attr("data-lab-id",lab_id)
        $("#choose-action-radiographer-modal button").attr("data-main-test-id",main_test_id)
        $("#choose-action-radiographer-modal button").attr("data-comments",comments)
  ...
  function inputResultsEdit (elem,evt,enter = true) {

    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patients_awaiting_radiographer_edit'); ?>";
    var form_data = {};
    view_mode = "enter";
    ...
    $.ajax({
      ...
      success : function (response) {
        ...
        $(".spinner-overlay").hide();
        if(response.success && response.messages != ""){
          $("#patients-awaiting-radiographer-card-edit .card-body").html(response.messages);
          $("#patients-awaiting-radiographer-card-edit #input-results-table").DataTable();
          $("#main-card").hide();
          
          $("#patients-awaiting-radiographer-card-edit .card-title").html("All Previously Processed Patients");
          
          $("#patients-awaiting-radiographer-card-edit").show();
        }else{
          $.notify({
          message:"Sorry Something Went Wrong."
          },{
  ...
  function goBackFromPatientsAwaitingRadiographerCardEdit (elem,evt) {
    $("#main-card").show();
    $("#patients-awaiting-radiographer-card-edit").hide();
  }
  ...
  function loadTestsAndPatientInfoEdit(elem,evt,lab_id,scroll_down = false,enter = true){
    ...
    if(lab_id != ""){
      patient_lab_id = lab_id;
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/view_patient_info_for_radiographer_edit'); ?>"
      var form_data = {
        show_records : true,
        lab_id : lab_id
      }
  ...
  function enterResultOfTestEdit(elem,evt,main_test_id,lab_id,enter = true){
    ...
    if(main_test_id != "" && lab_id != ""){
      patient_lab_id = lab_id;
      patient_main_test_id = main_test_id;
      var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/load_edit_result_form_for_radiographer_edit'); ?>";
      var form_data = {
        show_records : true,
        main_test_id : main_test_id,
        lab_id : lab_id
  ...
  function submitRadiographerCommentsEdit(elem,evt){
    elem = $(elem);
    var lab_id = elem.attr("data-lab-id");
    var main_test_id = elem.attr("data-main-test-id");
    ...
    if(comments_length >= 2){
      ...
      if(lab_id != "" && main_test_id != "" && comments != "" && type != ""){
        var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/submit_test_result_form_radiographer_or_sonologist_edit'); ?>";
        ...
        <?php } ?>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="card" id="patients-awaiting-radiographer-card" style="display: none;">
                <div class="card-header">
                  <button onclick="goBackFromPatientsAwaitingRadiographerCard(this,event)" class="btn btn-warning">Go Back</button>
                  <h3 class="card-title">Patient's Awaiting You</h3>
                </div>
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-hover" id="perform-action-on-patient-modal" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td onclick="inputResults(this,event)" class="text-primary">Input Results</td>
                        </tr>
                        <tr>
                          <td>2</td>
                          <td onclick="inputResultsEdit(this,event,false)" class="text-primary">View Previously Entered Results</td>
                        </tr>
